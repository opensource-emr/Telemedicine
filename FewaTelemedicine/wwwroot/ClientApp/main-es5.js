...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function srcCommonConfigServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _global_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./global.model */
    ...
    /*#__PURE__*/
    function () {
      function ConfigService(http, global) {
      ...
      _createClass(ConfigService, [{
        ...
        value: function loadAppConfig() {
          ...
          return this.http.get('/appconfig.json').toPromise().then(function (data) {
            _this.global.config = data;
          });
        }
      }]);
    ...
    ConfigService.ɵfac = function ConfigService_Factory(t) {
      return new (t || ConfigService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_global_model__WEBPACK_IMPORTED_MODULE_2__["GlobalModel"]));
    };
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ConfigService, [{
        ...
        return [{
          ...
          type: _global_model__WEBPACK_IMPORTED_MODULE_2__["GlobalModel"]
        }];
      }, null);
    })();
    /***/
  ...
  /***/
  function srcCommonGlobalModelTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_models_doctors_model__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
    /*! src/models/doctors.model */
    "./src/models/doctors.model.ts");
    /* harmony import */


    var src_models_patients_attended_model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! src/models/patients-attended.model */
    "./src/models/patients-attended.model.ts"); //import { PatientModel } from 'src/models/patient.model';
    ...
    var GlobalModel = function GlobalModel() {
      ...
      this.config = null; // this.patientObj = new PatientModel();
  ...
  /***/
  function srcCommonHttpInterceptorServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _global_model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./global.model */
    "./src/Common/global.model.ts");
    ...
    /*#__PURE__*/
    function () {
      function HttpInterceptorService(global) {
    ...
    HttpInterceptorService.ɵfac = function HttpInterceptorService_Factory(t) {
      return new (t || HttpInterceptorService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_global_model__WEBPACK_IMPORTED_MODULE_1__["GlobalModel"]));
    };
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](HttpInterceptorService, [{
        ...
        return [{
          type: _global_model__WEBPACK_IMPORTED_MODULE_1__["GlobalModel"]
        }];
      }, null);
    })();
    /***/
  ...
  /***/
  function srcCommonNotificationServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    /*#__PURE__*/
    function () {
      function NotificationService(global) {
      ...
      _createClass(NotificationService, [{
        ...
        value: function GetAllPatients() {
          this._hubConnection.invoke("GetPatientAll")["catch"](function (err) {
            console.log(err);
          });
        }
      }, {
        key: "CallPatient",
        value: function CallPatient(callPatient) {
          console.log(callPatient);

          this._hubConnection.invoke('PatientCall', callPatient)["catch"](function (err) {
            console.log(err);
          });
        }
      }, {
        key: "PatientAttended",
        value: function PatientAttended(attendPatient) {
          console.log(attendPatient);

          this._hubConnection.invoke('PatientAttended', attendPatient)["catch"](function (err) {
            console.log(err);
          });
        }
      }, {
        key: "SendChatMessage",
        value: function SendChatMessage(chatMessage) {
          this._hubConnection.invoke('SendChatMessage', chatMessage)["catch"](function (err) {
            console.log(err);
          });
        }
      }, {
        key: "LoadActiveDoctors",
        value: function LoadActiveDoctors() {
          this._hubConnection.invoke('GetActiveDoctors')["catch"](function (err) {
            console.log(err);
          });
        }
      }, {
        ...
        value: function createConnection() {
          this._hubConnection = new _aspnet_signalr__WEBPACK_IMPORTED_MODULE_1__["HubConnectionBuilder"]().withUrl(window.location.origin + '/NotificationHub?token=' + this.global.token).build();
        ...
        value: function startConnection() {
          ...
          this._hubConnection.start().then(function () {
            _this2.connectionIsEstablished = true;
            console.log('Hub connection started');

            _this2.EventConnectionEstablished.emit(true);
          })["catch"](function (err) {
          ...
          this._hubConnection.onclose(function (e) {
            alert('Connection Closed'); //setTimeout(function () { this.startConnection(); }, 5000);
          });
        }
      }, {
        ...
        value: function registerOnServerEvents() {
          ...
          this._hubConnection.on('GetAllPatients', function (data) {
            var obj = JSON.parse(data);

            _this3.EventGetAllPatients.emit(obj);
          });

          this._hubConnection.on('CallPatient', function (data) {
            var obj = JSON.parse(data);

            _this3.EventCallPatient.emit(obj);
          });

          this._hubConnection.on('CompletePatient', function (data) {
            console.log('Complete Patient' + data);
            var obj = JSON.parse(data);

            _this3.EventCompletePatient.emit(obj);
          });

          this._hubConnection.on('ChatMessage', function (data) {
            // console.log('Message' + data);
            var msg = JSON.parse(data);

            _this3.EventChatMessage.emit(msg);
          });

          this._hubConnection.on('GetAllDoctors', function (data) {
            var jsonData = JSON.parse(data);

            _this3.EventGetAllDoctors.emit(jsonData);
          });
        }
      }]);
    ...
    NotificationService.ɵfac = function NotificationService_Factory(t) {
      return new (t || NotificationService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_global_model__WEBPACK_IMPORTED_MODULE_2__["GlobalModel"]));
    };
  ...
  /***/
  function srcCommonSafePipeTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcCommonYesNoPipeTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "YesNoPipe", function () {
      return YesNoPipe;
    });
    /* harmony import */
    ...
    function () {
      function YesNoPipe() {
        _classCallCheck(this, YesNoPipe);
      }

      _createClass(YesNoPipe, [{
        key: "transform",
        value: function transform(value) {
    ...
    YesNoPipe.ɵfac = function YesNoPipe_Factory(t) {
      return new (t || YesNoPipe)();
    };

    YesNoPipe.ɵpipe = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefinePipe"]({
      name: "yesNoPipe",
      type: YesNoPipe,
      pure: true
    });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](YesNoPipe, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Pipe"],
        args: [{
          name: "yesNoPipe"
        }]
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _security_login_login_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./security/login/login.component */
    "./src/app/security/login/login.component.ts");
    /* harmony import */


    var _doctor_doctor_home_doctor_home_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./doctor/doctor-home/doctor-home.component */
    "./src/app/doctor/doctor-home/doctor-home.component.ts");
    /* harmony import */


    var _security_forgot_password_forgot_password_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./security/forgot-password/forgot-password.component */
    "./src/app/security/forgot-password/forgot-password.component.ts");
    /* harmony import */


    var _patient_patient_invitation_patient_invitation_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./patient/patient-invitation/patient-invitation.component */
    "./src/app/patient/patient-invitation/patient-invitation.component.ts");
    /* harmony import */


    var _patient_patient_waiting_room_patient_waiting_room_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./patient/patient-waiting-room/patient-waiting-room.component */
    "./src/app/patient/patient-waiting-room/patient-waiting-room.component.ts");
    /* harmony import */


    var _doctor_doctor_room_doctor_room_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./doctor/doctor-room/doctor-room.component */
    "./src/app/doctor/doctor-room/doctor-room.component.ts");
    /* harmony import */


    var _patient_patient_room_patient_room_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./patient/patient-room/patient-room.component */
    "./src/app/patient/patient-room/patient-room.component.ts");
    /* harmony import */


    var _patient_patient_report_summary_patient_report_summary_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./patient/patient-report-summary/patient-report-summary.component */
    "./src/app/patient/patient-report-summary/patient-report-summary.component.ts");
    /* harmony import */


    var _patient_patient_registation_patient_registration_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ./patient/patient-registation/patient-registration.component */
    ...
    var routes = [{
      ...
      path: 'Login',
      component: _security_login_login_component__WEBPACK_IMPORTED_MODULE_2__["LoginComponent"]
    }, {
      path: 'ForgotPassword',
      component: _security_forgot_password_forgot_password_component__WEBPACK_IMPORTED_MODULE_4__["ForgotPasswordComponent"]
    }, {
      path: 'Home',
      component: _doctor_doctor_home_doctor_home_component__WEBPACK_IMPORTED_MODULE_3__["DoctorHomeComponent"]
    }, {
      path: 'Invitation',
      component: _patient_patient_invitation_patient_invitation_component__WEBPACK_IMPORTED_MODULE_5__["PatientInvitationComponent"]
    }, {
      path: 'Join',
      component: _patient_patient_registation_patient_registration_component__WEBPACK_IMPORTED_MODULE_10__["PatientRegistrationComponent"]
    }, {
      path: 'Waiting',
      component: _patient_patient_waiting_room_patient_waiting_room_component__WEBPACK_IMPORTED_MODULE_6__["PatientWaitingRoomComponent"]
    }, {
      path: 'DoctorRoom',
      component: _doctor_doctor_room_doctor_room_component__WEBPACK_IMPORTED_MODULE_7__["DoctorRoomComponent"]
    }, {
      path: 'ReportSummary',
      component: _patient_patient_report_summary_patient_report_summary_component__WEBPACK_IMPORTED_MODULE_9__["PatientReportSummaryComponent"]
    }, {
      path: 'PatientRoom',
      component: _patient_patient_room_patient_room_component__WEBPACK_IMPORTED_MODULE_8__["PatientRoomComponent"]
    }];
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _security_login_login_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./security/login/login.component */
    "./src/app/security/login/login.component.ts");
    /* harmony import */
    ...
    var src_Common_config_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! src/Common/config.service */
    "./src/Common/config.service.ts");
    /* harmony import */


    var src_Common_global_model__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! src/Common/global.model */
    "./src/Common/global.model.ts");
    /* harmony import */


    var src_Common_http_interceptor_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! src/Common/http-interceptor.service */
    "./src/Common/http-interceptor.service.ts");
    /* harmony import */


    var _doctor_doctor_home_doctor_home_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ./doctor/doctor-home/doctor-home.component */
    "./src/app/doctor/doctor-home/doctor-home.component.ts");
    /* harmony import */


    var _security_forgot_password_forgot_password_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ./security/forgot-password/forgot-password.component */
    "./src/app/security/forgot-password/forgot-password.component.ts");
    /* harmony import */
    ...
    var _patient_patient_invitation_patient_invitation_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! ./patient/patient-invitation/patient-invitation.component */
    "./src/app/patient/patient-invitation/patient-invitation.component.ts");
    /* harmony import */


    var _doctor_doctor_room_doctor_room_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    /*! ./doctor/doctor-room/doctor-room.component */
    "./src/app/doctor/doctor-room/doctor-room.component.ts");
    /* harmony import */


    var _patient_patient_room_patient_room_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
    /*! ./patient/patient-room/patient-room.component */
    "./src/app/patient/patient-room/patient-room.component.ts");
    /* harmony import */


    var _patient_patient_registation_patient_registration_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
    /*! ./patient/patient-registation/patient-registration.component */
    "./src/app/patient/patient-registation/patient-registration.component.ts");
    /* harmony import */


    var src_Common_yes_no_pipe__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
    /*! src/Common/yes-no.pipe */
    "./src/Common/yes-no.pipe.ts");
    /* harmony import */


    var _patient_patient_report_summary_patient_report_summary_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
    /*! ./patient/patient-report-summary/patient-report-summary.component */
    "./src/app/patient/patient-report-summary/patient-report-summary.component.ts");
    /* harmony import */


    var src_Common_safe_pipe__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
    /*! src/Common/safe.pipe */
    "./src/Common/safe.pipe.ts");
    /* harmony import */


    var _patient_patient_waiting_room_patient_waiting_room_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
    /*! ./patient/patient-waiting-room/patient-waiting-room.component */
    "./src/app/patient/patient-waiting-room/patient-waiting-room.component.ts");

    var initializerConfigFn = function initializerConfigFn(config) {
      return function () {
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      providers: [{
        ...
        useClass: src_Common_http_interceptor_service__WEBPACK_IMPORTED_MODULE_9__["HttpInterceptorService"],
        multi: true
      }],
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_6__["HttpClientModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_12__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_12__["ReactiveFormsModule"], _angular_common__WEBPACK_IMPORTED_MODULE_5__["CommonModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"], _security_login_login_component__WEBPACK_IMPORTED_MODULE_4__["LoginComponent"], _security_forgot_password_forgot_password_component__WEBPACK_IMPORTED_MODULE_11__["ForgotPasswordComponent"], _doctor_doctor_home_doctor_home_component__WEBPACK_IMPORTED_MODULE_10__["DoctorHomeComponent"], _patient_patient_invitation_patient_invitation_component__WEBPACK_IMPORTED_MODULE_13__["PatientInvitationComponent"], _doctor_doctor_home_doctor_home_component__WEBPACK_IMPORTED_MODULE_10__["DoctorHomeComponent"], _doctor_doctor_room_doctor_room_component__WEBPACK_IMPORTED_MODULE_14__["DoctorRoomComponent"], _patient_patient_invitation_patient_invitation_component__WEBPACK_IMPORTED_MODULE_13__["PatientInvitationComponent"], _patient_patient_registation_patient_registration_component__WEBPACK_IMPORTED_MODULE_16__["PatientRegistrationComponent"], _patient_patient_room_patient_room_component__WEBPACK_IMPORTED_MODULE_15__["PatientRoomComponent"], _patient_patient_report_summary_patient_report_summary_component__WEBPACK_IMPORTED_MODULE_18__["PatientReportSummaryComponent"], _patient_patient_waiting_room_patient_waiting_room_component__WEBPACK_IMPORTED_MODULE_20__["PatientWaitingRoomComponent"], src_Common_yes_no_pipe__WEBPACK_IMPORTED_MODULE_17__["YesNoPipe"], src_Common_safe_pipe__WEBPACK_IMPORTED_MODULE_19__["SafePipe"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_6__["HttpClientModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_12__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_12__["ReactiveFormsModule"], _angular_common__WEBPACK_IMPORTED_MODULE_5__["CommonModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  /***/
  function srcAppDoctorDoctorHomeDoctorHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_models_doctors_model__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! src/models/doctors.model */
    "./src/models/doctors.model.ts");
    /* harmony import */
    ...
    var src_Common_notification_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! src/Common/notification.service */
    "./src/Common/notification.service.ts");
    /* harmony import */


    var src_Common_global_model__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! src/Common/global.model */
    "./src/Common/global.model.ts");
    /* harmony import */
    ...
    function DoctorHomeComponent_img_16_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function DoctorHomeComponent_img_17_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "img", 73);
      }
    }

    function DoctorHomeComponent_div_58_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function DoctorHomeComponent_div_58_Template_input_ngModelChange_8_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r10);

          var ctx_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r9.global.doctorObj.Email = $event;
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function DoctorHomeComponent_div_58_Template_input_ngModelChange_10_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r10);

          var ctx_r11 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r11.global.doctorObj.MobileNumber = $event;
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DoctorHomeComponent_div_58_Template_a_click_12_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r10);

          var ctx_r12 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r12.Invitation();
        });
    ...
    function DoctorHomeComponent_div_59_div_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function DoctorHomeComponent_div_59_tr_14_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function DoctorHomeComponent_div_59_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function DoctorHomeComponent_div_60_label_67_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function DoctorHomeComponent_div_60_span_69_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function DoctorHomeComponent_div_60_span_70_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span", 113);
    ...
    function DoctorHomeComponent_div_60_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function DoctorHomeComponent_div_60_Template_select_ngModelChange_11_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r21);

          var ctx_r20 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r20.doctorObj.NameTitle = $event;
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function DoctorHomeComponent_div_60_Template_input_ngModelChange_23_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r21);

          var ctx_r22 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r22.doctorObj.DoctorName = $event;
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function DoctorHomeComponent_div_60_Template_input_ngModelChange_28_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r21);

          var ctx_r23 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r23.doctorObj.Email = $event;
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function DoctorHomeComponent_div_60_Template_input_ngModelChange_33_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r21);

          var ctx_r24 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r24.doctorObj.MobileNumber = $event;
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function DoctorHomeComponent_div_60_Template_input_ngModelChange_38_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r21);

          var ctx_r25 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r25.doctorObj.Designation = $event;
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function DoctorHomeComponent_div_60_Template_input_ngModelChange_43_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r21);

          var ctx_r26 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r26.doctorObj.MedicalDegree = $event;
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function DoctorHomeComponent_div_60_Template_input_ngModelChange_48_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r21);

          var ctx_r27 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r27.doctorObj.Clinic = $event;
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function DoctorHomeComponent_div_60_Template_input_ngModelChange_53_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r21);

          var ctx_r28 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r28.doctorObj.Password = $event;
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function DoctorHomeComponent_div_60_Template_input_ngModelChange_58_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r21);

          var ctx_r29 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r29.doctorObj.ConfirmPassword = $event;
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function DoctorHomeComponent_div_60_Template_input_change_63_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r21);

          var ctx_r30 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r30.onFileChanged($event);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DoctorHomeComponent_div_60_Template_button_click_65_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r21);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DoctorHomeComponent_div_60_Template_input_click_74_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r21);

          var ctx_r32 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r32.UpdateProfile();
        });
    ...
    function DoctorHomeComponent_div_61_div_1_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 46);
    ...
    function DoctorHomeComponent_div_61_label_8_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function DoctorHomeComponent_div_61_select_9_option_3_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function DoctorHomeComponent_div_61_select_9_Template(rf, ctx) {
      if (rf & 1) {
        var _r42 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "select", 123);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function DoctorHomeComponent_div_61_select_9_Template_select_change_0_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r42);

          var ctx_r41 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2);

          return ctx_r41.OnChatUserChange();
        });
    ...
    function DoctorHomeComponent_div_61_div_10_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function DoctorHomeComponent_div_61_div_11_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function DoctorHomeComponent_div_61_div_12_div_2_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function DoctorHomeComponent_div_61_div_12_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("keyup", function DoctorHomeComponent_div_61_div_12_Template_textarea_keyup_1_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r47);

          var ctx_r46 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2);

          return ctx_r46.onChatEnter($event);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DoctorHomeComponent_div_61_div_12_Template_input_click_3_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r47);

          var ctx_r48 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2);

          return ctx_r48.SendChatMsg();
        });
    ...
    function DoctorHomeComponent_div_61_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function DoctorHomeComponent_div_71_tr_3_a_4_Template(rf, ctx) {
      if (rf & 1) {
        var _r55 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "a", 137);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DoctorHomeComponent_div_71_tr_3_a_4_Template_a_click_0_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r55);

          var temp_r50 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;

          var ctx_r53 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2);

          return ctx_r53.CallPatient(temp_r50);
        });
    ...
    function DoctorHomeComponent_div_71_tr_3_td_9_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function DoctorHomeComponent_div_71_tr_3_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "tr");
      ...
      if (rf & 2) {
        var temp_r50 = ctx.$implicit;

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate2"]("\xA0", temp_r50.Id, ")\xA0\xA0", temp_r50.PatientName, "");
    ...
    function DoctorHomeComponent_div_71_Template(rf, ctx) {
      if (rf & 1) {
    ...
    /*#__PURE__*/
    function () {
      function DoctorHomeComponent(routing, notificationService, global, httpClient, formBuilder, activatedRoute, cdr, sanitizer) {
        var _this4 = this;
        ...
        if (this.global.IsPatient) {
          this.notificationService.EventCompletePatient.subscribe(function (_patient) {
            _this4.global.patientObj = _patient;
            _this4.patients = _patient; // this.PatientCompleted(_patient);

            _this4.ChatUserDropDowns = new Array();
          });
        }

        this.notificationService.Connect();
        this.notificationService.EventGetAllPatients.subscribe(function (_patients) {
          _this4.patients = _patients;
          _this4.ChatUserDropDowns = _patients;
        });
        this.notificationService.EventCallPatient.subscribe(function (_patient) {
          _this4.global.patientObj = _patient;
        });
        this.notificationService.EventChatMessage.subscribe(function (data) {
          if (_this4.ChatForm.controls['selUser'].value != data.Name) {
            _this4.ChatForm.controls['selUser'].setValue(data.Name);

            _this4.OnChatUserChange();
          }
          ...
          _this4.ChatMessages.push(chatMsg); //this.ChatReceivedMessages.push(chatMsg);


          _this4.pushChatMsgUserwise(data.Name, chatMsg);

          _this4.cdr.detectChanges();

          _this4.scrollBottom.nativeElement.lastElementChild.scrollIntoView(); // scroll to bottom
      ...
      _createClass(DoctorHomeComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.httpClient.get(this.global.HospitalUrl + "GetUpdatedDoctor").subscribe(function (res) {
            _this5.doctorObj = res;
            _this5.retrievedImage = 'data:image/png;base64,' + _this5.doctorObj.Image;
          });
        ...
        key: "hasError",
        value: function hasError(typeofvalidator, controlname) {
          var control = this.ChatForm.controls[controlname];
          return control.hasError(typeofvalidator) && control.dirty;
        }
      }, {
        key: "Difference",
        value: function Difference(start, end) {
        ...
        value: function onFileChanged(event) {
          ...
          this.doctorObj.UserName = this.global.doctorObj.UserName; //this.doctorObj.Password = this.global.doctorObj.Password;

          fd.append('user', JSON.stringify(this.doctorObj));
          this.httpClient.post(this.global.HospitalUrl + "UploadImage", fd, {
            reportProgress: true,
            observe: 'events',
            responseType: 'json'
          }).subscribe(function (event) {
            if (event.type === _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpEventType"].UploadProgress) _this6.progress = Math.round(100 * event.loaded / event.total);else if (event.type === _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpEventType"].Response) {
              _this6.receivedImageData = event;
              _this6.message = 'Upload success.'; //this.onUploadFinished.emit(event.body);
            }
          });
        }
      }, {
        ...
        value: function getImage() {
          ...
          this.httpClient.get(this.global.HospitalUrl + "GetImage").subscribe(function (res) {
            _this7.retrieveResponse = res;
            _this7.retrievedImage = 'data:image/png;base64,' + _this7.retrieveResponse.Image;
          });
        }
      }, {
        key: "UpdateProfile",
        value: function UpdateProfile() {
          ...
          if (this.receivedImageData) this.doctorObj.Image = this.receivedImageData.body;

          if (this.doctorObj.Password == this.doctorObj.ConfirmPassword) {
            this.httpClient.post(this.global.HospitalUrl + "UpdateProfile", this.doctorObj).subscribe(function (res) {
              _this8.doctorObj = res; //this.global.doctorObj = res;

              _this8.getImage();

              alert("profile updated"); //if (this.doctorObj.Password == this.doctorObj.ConfirmPassword) {

              _this8.doctorObj = res; //this.doctorObj = new DoctorsModel();
              // }
            }, function (err) {
              console.log(err);
            });
        ...
        value: function Invitation() {
          ...
          this.httpClient.post("Messenger/SendEmail", this.global.doctorObj).subscribe(function (res) {
            return _this9.EmailInvitationSuccess(res);
          }, function (err) {
        ...
        key: "LoadPatientsAttended",
        value: function LoadPatientsAttended() {
          var _this10 = this;

          this.httpClient.get("Hospital/GetPatientsAttended").subscribe(function (res) {
            return _this10.LoadPatientSuccess(res);
          }, function (err) {
            return _this10.Error(err);
          });
        }
      }, {
        key: "LoadPatientSuccess",
        value: function LoadPatientSuccess(res) {
          this.CompletedPatients = res;
        }
      }, {
        key: "NextPatient",
        value: function NextPatient(res) {
          ...
          if (res) {
            ...
            this.routing.navigateByUrl('/DoctorRoom', {
              state: this.global.patientObj
            });
          }
        }
      }, {
        key: "EmailInvitationSuccess",
        value: function EmailInvitationSuccess(res) {
          console.log(res);
          if (res) alert("Email Invitation Sent has been sent ");else alert("Incorrect email address");
        ...
        value: function SendChatMsg() {
          try {
            for (var i in this.ChatForm.controls) {
        ...
        key: "OnChatUserChange",
        value: function OnChatUserChange() {
          try {
            var selUser = this.ChatForm.controls['selUser'].value;

            if (this.AllUserChats.hasOwnProperty(selUser)) {
              this.ChatMessages = this.AllUserChats[selUser].slice(); // this.ChatReceivedMessages=this.AllUserChats[selUser].slice();
            } else {
              this.ChatMessages = new Array(); // this.ChatReceivedMessages=new Array<any>();
            }
          } catch (e) {}
        }
      }, {
        key: "OnShowHideChat",
        value: function OnShowHideChat() {
          try {
        ...
        key: "onChatEnter",
        value: function onChatEnter(event) {
          if (event.keyCode === 13) {
            this.SendChatMsg();
          }
        }
      }, {
        key: "pushChatMsgUserwise",
        value: function pushChatMsgUserwise(user, messageObj) {
          try {
    ...
    DoctorHomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function DoctorHomeComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DoctorHomeComponent_Template_a_click_43_listener() {
            return ctx.Check("sendInv");
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DoctorHomeComponent_Template_a_click_46_listener() {
            return ctx.Check("completedList");
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DoctorHomeComponent_Template_a_click_49_listener() {
            return ctx.Check("accSett");
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DoctorHomeComponent_Template_a_click_52_listener() {
            return ctx.Check("chatSection");
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](79, "\xD7");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](126, "Powered by \xA9 Fewa Telehealth 2020 ");
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate2"]("", ctx.global.doctorObj.NameTitle, "\xA0", ctx.global.doctorObj.DoctorName, "");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate2"]("Hello!\xA0\xA0", ctx.global.doctorObj.NameTitle, "\xA0", ctx.global.doctorObj.DoctorName, " ");
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](DoctorHomeComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
        ...
        return [{
          ...
          type: src_Common_notification_service__WEBPACK_IMPORTED_MODULE_5__["NotificationService"]
        }, {
          type: src_Common_global_model__WEBPACK_IMPORTED_MODULE_6__["GlobalModel"]
        }, {
          type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]
        }, {
  ...
  /***/
  function srcAppDoctorDoctorRoomDoctorRoomComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "DoctorRoomComponent", function () {
      return DoctorRoomComponent;
    });
    /* harmony import */
    ...
    var src_Common_notification_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! src/Common/notification.service */
    "./src/Common/notification.service.ts");
    /* harmony import */


    var src_Common_global_model__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! src/Common/global.model */
    "./src/Common/global.model.ts");
    /* harmony import */
    ...
    var src_Common_safe_pipe__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! src/Common/safe.pipe */
    "./src/Common/safe.pipe.ts");

    var _c0 = ["scrollBtm"];

    function DoctorRoomComponent_label_72_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function DoctorRoomComponent_select_73_option_3_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "option");
    ...
    function DoctorRoomComponent_select_73_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function DoctorRoomComponent_select_73_Template_select_change_0_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r73);

          var ctx_r72 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r72.OnChatUserChange();
        });
    ...
    function DoctorRoomComponent_div_74_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function DoctorRoomComponent_div_75_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function DoctorRoomComponent_div_76_div_2_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function DoctorRoomComponent_div_76_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("keyup", function DoctorRoomComponent_div_76_Template_textarea_keyup_1_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r78);

          var ctx_r77 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r77.onChatEnter($event);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DoctorRoomComponent_div_76_Template_input_click_3_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r78);

          var ctx_r79 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r79.SendChatMsg();
        });
    ...
    function DoctorRoomComponent_div_112_input_47_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DoctorRoomComponent_div_112_input_47_Template_input_click_0_listener() {
          ...
          return ctx_r81.PatientAttended(ctx_r81.global.patientObj);
        });
    ...
    function DoctorRoomComponent_div_112_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function DoctorRoomComponent_div_112_Template_input_ngModelChange_13_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r84);

          var ctx_r83 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r83.global.patientObj.LabOrdersSent = $event;
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](15, " \xA0Lab Orders Sent ");
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function DoctorRoomComponent_div_112_Template_input_ngModelChange_19_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r84);

          var ctx_r85 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r85.global.patientObj.NewPrescriptionsSentToYourPharmacy = $event;
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](21, " \xA0New prescriptions sent to your pharmacy ");
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function DoctorRoomComponent_div_112_Template_input_ngModelChange_25_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r84);

          var ctx_r86 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r86.global.patientObj.NewPrescriptionsMailedToYou = $event;
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](27, " \xA0New prescriptions mailed to you ");
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function DoctorRoomComponent_div_112_Template_textarea_ngModelChange_31_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r84);

          var ctx_r87 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r87.global.patientObj.Medication = $event;
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function DoctorRoomComponent_div_112_Template_input_ngModelChange_36_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r84);

          var ctx_r88 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r88.global.patientObj.FollowUpNumber = $event;
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function DoctorRoomComponent_div_112_Template_select_ngModelChange_38_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r84);

          var ctx_r89 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r89.global.patientObj.FollowUpMeasure = $event;
        });
    ...
    var DoctorRoomComponent =
    /*#__PURE__*/
    function () {
      function DoctorRoomComponent(httpClient, routing, formBuilder, notificationService, global, cdr) {
        var _this11 = this;

        _classCallCheck(this, DoctorRoomComponent);
        ...
        if (this.global.IsPatient) {
          this.notificationService.EventCompletePatient.subscribe(function (_patient) {
            _this11.global.patientObj = _patient;

            _this11.PatientCompleted(_patient);

            _this11.ChatUserDropDowns = new Array();
          });
          this.notificationService.EventGetAllDoctors.subscribe(function (_doctors) {
            _this11.ChatUserDropDowns = _doctors;
          }); // gets doctor list
          ...
          this.notificationService.Connect();
          this.notificationService.EventGetAllPatients.subscribe(function (_patients) {
            _this11.patients = _patients;
            _this11.ChatUserDropDowns = _patients;
            console.log(_this11.ChatUserDropDowns);
          });
          this.notificationService.EventCallPatient.subscribe(function (_patient) {
            _this11.global.patientObj = _patient;
          });
        ...
        this.notificationService.EventChatMessage.subscribe(function (data) {
          if (_this11.ChatForm.controls['selUser'].value != data.Name) {
            _this11.ChatForm.controls['selUser'].setValue(data.Name);

            _this11.OnChatUserChange();
          }

          if (!_this11.showChat) {
            _this11.showChat = true;
          }
          ...
          _this11.ChatMessages.push(chatMsg); //this.ChatReceivedMessages.push(chatMsg);


          _this11.pushChatMsgUserwise(data.Name, chatMsg);

          _this11.cdr.detectChanges();

          _this11.scrollBottom.nativeElement.lastElementChild.scrollIntoView(); // scroll to bottom

        });
      }

      _createClass(DoctorRoomComponent, [{
        key: "initForm",
        value: function initForm() {
          this.ChatForm = this.formBuilder.group({
        ...
        key: "PatientAttended",
        value: function PatientAttended(attendedPatient) {
          this.showPatDetail = false;
          attendedPatient.Medication = this.global.patientObj.Medication;
          this.notificationService.PatientAttended(attendedPatient);
          this.global.patientObj = attendedPatient; //this.patients.push(attendedPatient)
        ...
        key: "PatientCompleted",
        value: function PatientCompleted(res) {
    ...
    DoctorRoomComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      pipes: [src_Common_safe_pipe__WEBPACK_IMPORTED_MODULE_7__["SafePipe"]],
      encapsulation: 2
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](DoctorRoomComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
        ...
        return [{
          ...
          type: src_Common_notification_service__WEBPACK_IMPORTED_MODULE_4__["NotificationService"]
        }, {
          type: src_Common_global_model__WEBPACK_IMPORTED_MODULE_5__["GlobalModel"]
        }, {
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ChangeDetectorRef"]
        }];
      }, {
  ...
  /***/
  function srcAppPatientPatientInvitationPatientInvitationComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "PatientInvitationComponent", function () {
      return PatientInvitationComponent;
    });
    /* harmony import */
    ...
    var src_Common_global_model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! src/Common/global.model */
    "./src/Common/global.model.ts");
    /* harmony import */
    ...
    PatientInvitationComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function PatientInvitationComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](72, "Powered by \xA9 Fewa Telehealth 2020 ");
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate2"]("", ctx.global.doctorObj.NameTitle, "\xA0\xA0", ctx.global.doctorObj.DoctorName, "");
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](PatientInvitationComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
        ...
        return [{
          type: src_Common_global_model__WEBPACK_IMPORTED_MODULE_1__["GlobalModel"]
        }, {
  ...
  /***/
  function srcAppPatientPatientRegistationPatientRegistrationComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_Common_global_model__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! src/Common/global.model */
    "./src/Common/global.model.ts");
    /* harmony import */
    ...
    var src_Common_notification_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! src/Common/notification.service */
    "./src/Common/notification.service.ts");

    var PatientRegistrationComponent =
    /*#__PURE__*/
    function () {
      function PatientRegistrationComponent(httpClient, routing, global, formBuilder, notificationService, route) {
      ...
      _createClass(PatientRegistrationComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.route.queryParams.subscribe(function (param) {
            _this12.meetingId = param['MeetingId'];
            _this12.global.patientObj.MeetingId = _this12.meetingId;
          });
        }
      }, {
        key: "LoginPatient",
        value: function LoginPatient() {
          var _this13 = this;

          this.patientObj.MeetingId = this.meetingId;
          this.httpClient.post(this.global.HospitalUrl + "LoginPatient", this.patientObj).subscribe(function (res) {
            _this13.global.token = res.Value.Token;
            _this13.global.IsDoctor = false;
            _this13.global.IsPatient = true;
            _this13.global.patientObj = res.Value.User;
            _this13.global.patientObj = res.Value;
            _this13.global.patientObj.Id = res.Value.Id;
            _this13.global.patientObj.PatientName = res.Value.PatientName;

            _this13.routing.navigateByUrl('/Waiting', {
              state: _this13.global.patientObj
            });
          }, function (res) {
    ...
    PatientRegistrationComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 57,
      vars: 1,
      consts: [["id", "page-top"], ["id", "wrapper"], ["id", "content-wrapper", 1, "d-flex", "flex-column"], ["id", "content"], [1, "navbar", "navbar-expand", "navbar-light", "bg-white", "topbar", "mb-4", "static-top", "shadow"], ["id", "sidebarToggleTop", 1, "btn", "btn-link", "d-md-none", "rounded-circle", "mr-3"], [1, "fa", "fa-bars"], ["href", "index.html", 1, "sidebar-brand", "d-flex", "align-items-center", "justify-content-center"], [1, "sidebar-brand-text", "mx-3"], ["src", "img/logo.png", "alt", ""], [1, "navbar-nav", "ml-auto"], [1, "topbar-divider", "d-none", "d-sm-block"], [1, "nav-item", "dropdown", "no-arrow"], ["href", "#", "id", "userDropdown", "role", "button", "data-toggle", "dropdown", "aria-haspopup", "true", "aria-expanded", "false", 1, "nav-link", "dropdown-toggle"], [1, "mr-2", "d-none", "d-lg-inline", "text-gray-600", "small"], ["src", "https://source.unsplash.com/QAB-WJcbgJk/60x60", 1, "img-profile", "rounded-circle"], ["aria-labelledby", "userDropdown", 1, "dropdown-menu", "dropdown-menu-right", "shadow", "animated--grow-in"], ["href", "#", 1, "dropdown-item"], [1, "fas", "fa-user", "fa-sm", "fa-fw", "mr-2", "text-gray-400"], [1, "fas", "fa-cogs", "fa-sm", "fa-fw", "mr-2", "text-gray-400"], [1, "fas", "fa-list", "fa-sm", "fa-fw", "mr-2", "text-gray-400"], [1, "dropdown-divider"], ["href", "#", "data-toggle", "modal", "data-target", "#logoutModal", 1, "dropdown-item"], [1, "fas", "fa-sign-out-alt", "fa-sm", "fa-fw", "mr-2", "text-gray-400"], [1, "container-fluid"], [1, "row", "m-w100"], [1, "col-md-5", "col-sm-12", "col-xs-12", "m-auto", "text-center"], [1, "mt-4"], [1, "d-block", "mt-1", "mb-4", 2, "font-size", "13px"], [1, "fa", "fa-info-circle"], [1, "card"], [1, "card-body", "pt-5", "pb-5"], ["action", "", 1, "user"], ["type", "text", "placeholder", "Enter Your Name", "name", "PatientName", 1, "form-control", "post-invitation", 3, "ngModel", "ngModelChange"], [1, "custom-control", "custom-checkbox", "mt-4"], ["type", "checkbox", "id", "customCheck", 1, "custom-control-input"], ["for", "customCheck", 1, "custom-control-label", "font-weight-normal"], ["href", ""], ["type", "submit", "href", "javascrpt:;", 1, "btn", "btn-primary", "d-inline", "mt-5", 2, "width", "150px", 3, "click"], [1, "sticky-footer", "bg-white"], [1, "container", "my-auto"], [1, "copyright", "text-center", "my-auto"], [1, ""], ["src", "img/logo-cap.png", 1, "powered-footer-logo"]],
      template: function PatientRegistrationComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function PatientRegistrationComponent_Template_input_ngModelChange_42_listener($event) {
            return ctx.patientObj.PatientName = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function PatientRegistrationComponent_Template_button_click_49_listener() {
            return ctx.LoginPatient();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](55, "Powered by \xA9 Fewa Telehealth 2020 ");
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](PatientRegistrationComponent, [{
        ...
        return [{
          ...
          type: src_Common_global_model__WEBPACK_IMPORTED_MODULE_4__["GlobalModel"]
        }, {
          type: _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormBuilder"]
        }, {
          type: src_Common_notification_service__WEBPACK_IMPORTED_MODULE_6__["NotificationService"]
        }, {
  ...
  /***/
  function srcAppPatientPatientReportSummaryPatientReportSummaryComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "PatientReportSummaryComponent", function () {
      return PatientReportSummaryComponent;
    });
    /* harmony import */
    ...
    var src_Common_global_model__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! src/Common/global.model */
    "./src/Common/global.model.ts");
    /* harmony import */


    var src_Common_yes_no_pipe__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! src/Common/yes-no.pipe */
    "./src/Common/yes-no.pipe.ts");

    var PatientReportSummaryComponent =
    /*#__PURE__*/
    function () {
      function PatientReportSummaryComponent(httpClient, routing, global) {
        _classCallCheck(this, PatientReportSummaryComponent);
      ...
      _createClass(PatientReportSummaryComponent, [{
        key: "SuccessTestDone",
        value: function SuccessTestDone(res) {
          this.global.patientObj = res;
          alert(res);
        }
      }]);
    ...
    PatientReportSummaryComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function PatientReportSummaryComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "body", 0);
      ...
      pipes: [src_Common_yes_no_pipe__WEBPACK_IMPORTED_MODULE_4__["YesNoPipe"]],
      styles: ["table[_ngcontent-%COMP%]{\n                        font-family: 'Verdana';\n                      }\n                      @media Print{\n                        table[_ngcontent-%COMP%]{\n                          font-family: 'Verdana';\n                        }\n                      }"]
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](PatientReportSummaryComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
        ...
        return [{
          ...
          type: src_Common_global_model__WEBPACK_IMPORTED_MODULE_3__["GlobalModel"]
        }];
      }, null);
    })();
    /***/
  ...
  /***/
  function srcAppPatientPatientRoomPatientRoomComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "PatientRoomComponent", function () {
      return PatientRoomComponent;
    });
    /* harmony import */
    ...
    var src_Common_notification_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! src/Common/notification.service */
    "./src/Common/notification.service.ts");
    /* harmony import */
    ...
    function PatientRoomComponent_img_8_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function PatientRoomComponent_img_9_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "img", 58);
      }
    }

    function PatientRoomComponent_option_33_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "option");
    ...
    function PatientRoomComponent_div_34_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function PatientRoomComponent_div_35_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function PatientRoomComponent_div_38_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var PatientRoomComponent =
    /*#__PURE__*/
    function () {
      function PatientRoomComponent(notificationService, global, routing, formBuilder, cdr, sanitizer) {
        var _this14 = this;

        _classCallCheck(this, PatientRoomComponent);
        ...
        this.initForm();
        this.notificationService.EventCompletePatient.subscribe(function (_patient) {
          _this14.global.patientObj = _patient;

          _this14.SuccessTestDone(_patient);
        });
        this.notificationService.EventChatMessage.subscribe(function (chatData) {
          if (_this14.ChatForm.controls['selUser'].value != chatData.Name) {
            _this14.ChatForm.controls['selUser'].setValue(chatData.Name);

            _this14.OnChatUserChange();
          }

          if (!_this14.showChat) {
            _this14.showChat = true;
          }
          ...
          _this14.ChatMessages.push(chatMsg); //this.ChatReceivedMessages.push(chatMsg);


          _this14.pushChatMsgUserwise(chatData.Name, chatMsg); // this.cdr.detectChanges();
          //this.scrollBottom.nativeElement.lastElementChild.scrollIntoView(); // scroll to bottom

        });
        this.notificationService.EventGetAllDoctors.subscribe(function (_doctors) {
          _this14.doctors = _doctors;
          console.log(_this14.doctors);
        }); // gets doctor list

        this.notificationService.LoadActiveDoctors();
      }

      _createClass(PatientRoomComponent, [{
        key: "Transform",
        value: function Transform() {
          return this.sanitizer.bypassSecurityTrustResourceUrl(this.retrievedImage);
        }
    ...
    PatientRoomComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function PatientRoomComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function PatientRoomComponent_Template_select_change_30_listener() {
            return ctx.OnChatUserChange();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("keyup", function PatientRoomComponent_Template_textarea_keyup_37_listener($event) {
            return ctx.onChatEnter($event);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function PatientRoomComponent_Template_input_click_39_listener() {
            return ctx.SendChatMsg();
          });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](PatientRoomComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
        ...
        return [{
          type: src_Common_notification_service__WEBPACK_IMPORTED_MODULE_2__["NotificationService"]
        }, {
          type: src_Common_global_model__WEBPACK_IMPORTED_MODULE_3__["GlobalModel"]
        }, {
          type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]
  ...
  /***/
  function srcAppPatientPatientWaitingRoomPatientWaitingRoomComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "PatientWaitingRoomComponent", function () {
      return PatientWaitingRoomComponent;
    });
    /* harmony import */
    ...
    var src_Common_notification_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! src/Common/notification.service */
    "./src/Common/notification.service.ts");
    /* harmony import */
    ...
    function PatientWaitingRoomComponent_label_33_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function PatientWaitingRoomComponent_option_37_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "option");
    ...
    function PatientWaitingRoomComponent_div_38_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function PatientWaitingRoomComponent_div_41_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var PatientWaitingRoomComponent =
    /*#__PURE__*/
    function () {
      function PatientWaitingRoomComponent(httpClient, notificationService, routing, formBuilder, global, cdr) {
        var _this15 = this;

        _classCallCheck(this, PatientWaitingRoomComponent);
        ...
        this.initForm();
        this.notificationService.Connect();
        this.notificationService.EventCallPatient.subscribe(function (patient) {
          _this15.GotoDoctorRoom(patient);
        });
        this.notificationService.EventChatMessage.subscribe(function (chatData) {
          if (_this15.ChatForm.controls['selUser'].value != chatData.Name) {
            _this15.ChatForm.controls['selUser'].setValue(chatData.Name);

            _this15.OnChatUserChange();
          }

          if (!_this15.showChat) {
            _this15.showChat = true;
          }
          ...
          _this15.ChatMessages.push(chatMsg);

          _this15.pushChatMsgUserwise(chatData.Name, chatMsg);

          _this15.cdr.detectChanges();

          _this15.scrollBottom.nativeElement.lastElementChild.scrollIntoView(); // scroll to bottom

        });
        this.notificationService.EventGetAllDoctors.subscribe(function (_doctors) {
          _this15.doctors = _doctors;
        });
        this.notificationService.EventConnectionEstablished.subscribe(function () {
          _this15.notificationService.LoadActiveDoctors();
        });
      }

      _createClass(PatientWaitingRoomComponent, [{
        key: "ngAfterViewInit",
        ...
        key: "SendToken",
        value: function SendToken(res) {}
      }, {
        key: "GotoDoctorRoom",
        value: function GotoDoctorRoom(res) {
          var _this16 = this;
          ...
          if (res.DoctorNameAttending.length > 0 && res.Name == this.global.patientObj.PatientName) {
            ...
            this.httpClient.get(this.global.HospitalUrl + "GetUpdatedDoctor").subscribe(function (res) {
              _this16.global.doctorObj = res;

              var url = _this16.global.config.videourl.replace("DOCTORNAME", _this16.global.patientObj.DoctorNameAttending);

              _this16.global.config.videourl = url;

              _this16.routing.navigate(['/PatientRoom']);
    ...
    PatientWaitingRoomComponent.ɵfac = function PatientWaitingRoomComponent_Factory(t) {
      return new (t || PatientWaitingRoomComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_Common_notification_service__WEBPACK_IMPORTED_MODULE_3__["NotificationService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_Common_global_model__WEBPACK_IMPORTED_MODULE_5__["GlobalModel"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ChangeDetectorRef"]));
    };

    PatientWaitingRoomComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: PatientWaitingRoomComponent,
      selectors: [["ng-component"]],
      viewQuery: function PatientWaitingRoomComponent_Query(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵviewQuery"](_c0, true);
      ...
      template: function PatientWaitingRoomComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function PatientWaitingRoomComponent_Template_select_change_34_listener() {
            return ctx.OnChatUserChange();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("keyup", function PatientWaitingRoomComponent_Template_textarea_keyup_40_listener($event) {
            return ctx.onChatEnter($event);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function PatientWaitingRoomComponent_Template_input_click_42_listener() {
            return ctx.SendChatMsg();
          });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](PatientWaitingRoomComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
        ...
        return [{
          ...
          type: src_Common_notification_service__WEBPACK_IMPORTED_MODULE_3__["NotificationService"]
        }, {
          type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]
        }, {
          type: _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"]
  ...
  /***/
  function srcAppSecurityForgotPasswordForgotPasswordComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    /*#__PURE__*/
    function () {
      function ForgotPasswordComponent(httpClient, routing, global) {
      ...
      _createClass(ForgotPasswordComponent, [{
        ...
        value: function GenerateOTP() {
          ...
          this.httpClient.get("/api/Clinical/?MobileNumber=" + this.mobno).subscribe(function (res) {
            return _this17.Success(res);
          }, function (res) {
            return _this17.Error(res);
          });
        }
      }, {
        key: "VerifyOTP",
        value: function VerifyOTP() {
          ...
          this.httpClient.post("/api/Clinical/VerifyOTP", obj).subscribe(function (res) {
            return _this18.SuccessVerify(res);
          }, function (res) {
            return _this18.Error(res);
          });
        }
      }, {
        key: "Success",
        ...
        key: "SuccessVerify",
        value: function SuccessVerify(res) {
          localStorage.setItem("MobileOTP", this.verifyotp); //localStorage.setItem("MobileNumber",this.mobno);

          this.routing.navigate(['/Login']);
        }
      }, {
        key: "Error",
        value: function Error(res) {// if(res.error.Message)
    ...
    ForgotPasswordComponent.ɵfac = function ForgotPasswordComponent_Factory(t) {
      return new (t || ForgotPasswordComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_Common_global_model__WEBPACK_IMPORTED_MODULE_3__["GlobalModel"]));
    };
    ...
    ForgotPasswordComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 47,
      vars: 1,
      consts: [[1, "bg-gradient-primary"], [1, "container"], [1, "row", "justify-content-center"], [1, "col-xl-10", "col-lg-12", "col-md-9"], [1, "card", "o-hidden", "border-0", "shadow-lg", "my-5"], [1, "card-body", "p-0"], [1, "row"], [1, "d-flex", "col-lg-6", "d-none", "d-lg-block", "bg-light"], [1, "align-self-stretch", "login-left"], ["src", "img/logo.png"], [1, "my-3"], [1, "fa", "fa-phone"], [1, "text-primary"], [1, "fa", "fa-envelope"], ["href", ""], [1, "col-lg-6"], [1, "p-5"], [1, "text-center"], [1, "h3", "text-gray-700", "mb-4", "heading-text"], [1, "h6", "d-block", "mt-2"], [1, "user"], [1, "form-group"], ["name", "mobno", "type", "email", "id", "exampleInputEmail", "aria-describedby", "emailHelp", "placeholder", "Your Email or mobile number", 1, "form-control", "form-control-user", 3, "ngModel", "ngModelChange"], ["href", "javascript:;", 1, "btn", "btn-primary", "btn-user", "d-block", 3, "click"], ["href", "javascript:;", 1, "d-block", "mt-4", "text-center", 2, "color", "#999"], [1, "sticky-footer", "bg-transparent"], [1, "container", "my-auto"], [1, "copyright", "text-center", "my-auto"], [1, "text-white"], ["src", "img/logo-cap.png", 1, "powered-footer-logo", "d-block"]],
      template: function ForgotPasswordComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function ForgotPasswordComponent_Template_input_ngModelChange_33_listener($event) {
            return ctx.mobno = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ForgotPasswordComponent_Template_a_click_35_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ForgotPasswordComponent_Template_a_click_37_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](46, "Powered by \xA9 Fewa Telehealth 2020 ");
  ...
  function srcAppSecurityLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_models_doctors_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! src/models/doctors.model */
    "./src/models/doctors.model.ts");
    /* harmony import */
    ...
    /*#__PURE__*/
    function () {
      function LoginComponent(httpClient, routing, global, formBuilder) {
      ...
      _createClass(LoginComponent, [{
        ...
        key: "LoadHospitalParams",
        value: function LoadHospitalParams() {
          var _this19 = this;

          this.httpClient.get(this.global.HospitalUrl + 'GetHospitalParams').subscribe(function (res) {
            if (res && res.Value && res.Value.length > 0) {
              var params = res.Value;
              _this19.hospitalDetails.description = params.find(function (a) {
                return a.ParameterName === 'Description';
              }) ? params.find(function (a) {
                return a.ParameterName === 'Description';
              }).ParameterValue : '';
              _this19.hospitalDetails.contactNo = params.find(function (a) {
                return a.ParameterName === 'ContactNumber';
              }) ? params.find(function (a) {
                return a.ParameterName === 'ContactNumber';
              }).ParameterValue : '';
              _this19.hospitalDetails.email = params.find(function (a) {
                return a.ParameterName === 'Email';
              }) ? params.find(function (a) {
                return a.ParameterName === 'Email';
              }).ParameterValue : '';
              _this19.hospitalDetails.logoPath = params.find(function (a) {
                return a.ParameterName === 'LogoPath';
              }) ? params.find(function (a) {
                return a.ParameterName === 'LogoPath';
              }).ParameterValue : '';
            }
        ...
        value: function LoginDoctor() {
          ...
          this.doctorObj.UserName = this.doctorFrm.value.docUsrName; //this.doctorObj.Password = this.doctorFrm.value.docPassword;

          this.global.doctorObj = this.doctorObj;
          this.httpClient.post(this.global.ApiUrl + "Security/Login", this.doctorObj).subscribe(function (res) {
            _this20.global.token = res.Token;
            _this20.global.IsDoctor = true;
            _this20.global.doctorObj = res.User;

            var url = _this20.global.config.videourl.replace("DOCTORNAME", _this20.global.doctorObj.UserName);

            _this20.global.config.videourl = url;

            _this20.routing.navigate(['Home']);
          }, function (res) {
            alert('Can not connect please talk with admin.');
          });
        }
    ...
    LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function LoginComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function LoginComponent_Template_a_click_46_listener() {
            return ctx.LoginDoctor();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](53, "Powered by \xA9 Fewa Telehealth 2020 ");
  ...
  /***/
  function srcModelsDoctorsModelTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "DoctorsModel", function () {
      return DoctorsModel;
    });

    var DoctorsModel = function DoctorsModel() {
      _classCallCheck(this, DoctorsModel);
  ...
  /***/
  function srcModelsPatientsAttendedModelTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "PatientsAttendedModel", function () {
      return PatientsAttendedModel;
    });

    var PatientsAttendedModel = function PatientsAttendedModel() {
      _classCallCheck(this, PatientsAttendedModel);
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! E:\Tele\Telemedicine\FewaTelemedicine\ClientApp\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
